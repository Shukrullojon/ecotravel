    ...
    <div class="flexslider">
        <ul class="slides">
            <li>
                ...
                <img src="{{ asset('template/images/templatemo_slide_1.jpg')}}" alt="Special 1">
                <div class="container">
                    <div class="row">
            ...
            <li>
                <div class="overlay"></div>
                <img src="{{ asset('template/images/templatemo_slide_2.jpg')}}" alt="Special 2">
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-lg-4">
                            <div class="flex-caption visible-lg">
            ...
            <li>
                <div class="overlay"></div>
                <img src="{{ asset('template/images/templatemo_slide_3.jpg')}}" alt="Special 3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-lg-4">
                            <div class="flex-caption visible-lg">
            ...
            <div class="our-listing owl-carousel">
                <div class="list-item">
                    <div class="list-thumb">
                        ...
                        <img src="{{ asset('template/images/destination_1.jpg')}}" alt="destination 1">
                    </div> <!-- /.list-thumb -->
                ...
                <div class="list-item">
                    <div class="list-thumb">
                        ...
                        <img src="{{ asset('template/images/destination_2.jpg')}}" alt="destination 2">
                    </div> <!-- /.list-thumb -->
                    <div class="list-content">
                ...
                <div class="list-item">
                    <div class="list-thumb">
                        ...
                        <img src="{{ asset('template/images/destination_3.jpg')}}" alt="destination 3">
                    </div> <!-- /.list-thumb -->
                    <div class="list-content">
                ...
                <div class="list-item">
                    <div class="list-thumb">
                        ...
                        <img src="{{ asset('template/images/destination_4.jpg')}}" alt="destination 4">
                    </div> <!-- /.list-thumb -->
                    <div class="list-content">
                ...
                <div class="list-item">
                    <div class="list-thumb">
                        ...
                        <img src="{{ asset('template/images/destination_5.jpg')}}" alt="destination 5">
                    </div> <!-- /.list-thumb -->
                    <div class="list-content">
                ...
                <div class="list-item">
                    <div class="list-thumb">
                        ...
                        <img src="{{ asset('template/images/destination_6.jpg')}}" alt="destination 6">
                    </div> <!-- /.list-thumb -->
                    <div class="list-content">
